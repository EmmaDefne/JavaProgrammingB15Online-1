...
public class ExcelVisualizer {
   ...
   { {78,54,100,84},{33,44,77,123},{12,88,52,76},{67,33,98,67},{12,88,52,45},{67,33,98,34} };
    ...
    //tell me how to print 100 and 90 from this array
     ...
     //in this 2d array object, we have 3 1D array object store
         System.out.println("object" + myExcel.length);

         //how many item do I have in first item of this 2D array
        System.out.println(Arrays.toString(myExcel[0]));// seeing what is inside first 1D array

        System.out.println(myExcel[0].length);//getting the lenght of first 1D array
        ...
        for (int x = 0; x <myExcel.length ; x++) {
            System.out.println("Item number "+ x + " lenght is: " + myExcel[x].length);
